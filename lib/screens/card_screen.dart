...
import 'package:softagi_api/model/cart_model.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Payment Options',
                  style: TextStyle(fontSize: 26.0, fontWeight: FontWeight.w700, color: Colors.black)),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Image.asset("images/american-express.png", width: 40.0),
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Image.asset("images/mastercard.png", width: 40.0),
                      ),
                    ),
                    const SizedBox(width: 15.0),
                    Container(
                      ...
                      child: Center(
                        child: Image.asset("images/visa.png", width: 40.0),
                      ),
                    ),
                  ],
                ),
